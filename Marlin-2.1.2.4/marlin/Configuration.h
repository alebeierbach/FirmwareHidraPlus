...
#define CUSTOM_MACHINE_NAME "Hidra Plus"
...
#define HOTEND_OFFSET_X { 0.0, 405.00 } // (mm) relative X-offset for each nozzle
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 40, 40, 400, 131, 131}
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 500, 500, 100, 1000 } //{ 3000, 3000, 100, 10000 }
